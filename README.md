...
- 右键语录菜单新增一个“备注”，于是用户可以给对应的语录备注，就相当于QQ备注好友的功能，于是显示的时候就只显示备注，同时备注标蓝（颜色待定）【出意外了，所以下版本先更新这个】  
...
- 用户可以在主窗口左上角添加或删除几个标签，点击不同的标签显示不同语录。就是一个对语录进行分类的功能。唔这个功能想想都麻烦，要是实现它的话估计又是一次大改动...如果以后我有能力了的话我也会回来实现这个功能的  
...
可惜吾爱论坛不允许留下任何联系方式，不然我肯定把他们都拉过来点个Star。  