...
#### 方法一：
看到右边的发行版（Releases）了吗？点它→，于是进入项目发布页，再点击QuickSay_v1.2.0.7z，于是开始下载  
下载完成后，将得到的文件解压，于是得到  
```
QuickSay文件夹
...
然后点击QuickSay_v1.2.0.7z，再点下载按钮，于是开始下载  
接下来的步骤同上  
...
- 右键语录菜单新增一个“备注”，于是用户可以给对应的语录备注，就相当于QQ备注好友的功能，于是显示的时候只显示备注，同时备注标蓝（颜色待定）【出意外了，所以下版本先更新这个】  
